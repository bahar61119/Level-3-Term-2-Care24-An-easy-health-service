...
<!--    <div class="col-md-3">
    ...
    <div id="Create">
        ...
        <?php
        echo form_open('signin_con/authentication');
        ?>
        <div class="row-fluid">
            <div class="span4"></div>
                <div class="span5">
        ...
        <div class="form-group col-md-9">
         ...
         <input type="submit" class ="btn btn-success" value="Login" />
                             <br><br><br>
        <a href="<?php echo site_url('admin_con/signin'); ?>">sign in as admin</a>
        
                             <br><br>
        <a href="<?php echo site_url('register_doctor'); ?>">Register as Doctor</a>
        
        
                             <br><br>
        <a href="<?php echo site_url('register_attendant'); ?>">Register as Attendant</a>
