...
public class CatHosListActivity extends ListActivity{
    ...
    private static final String TAG_ID = "h_id";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hospital_list);
		 ...
		 dept_id = this.getIntent().getStringExtra("id");
		 Log.d("Response: ", "> " + dept_id);
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
               ...
               Intent in = new Intent(getApplicationContext(),
                        DocHosListActivity.class);
                in.putExtra(TAG_ID, h_id);
                in.putExtra(TAG_DEPT_ID, dept_id);
 ...
 ////////////////////////////////////////////////////////////////////
    ...
    private class GetDoctors extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(CatHosListActivity.this);
		...
		protected Void doInBackground(Void... params) {
            ...
            url=""+CommonUtilities.SERVER_URL+"/api.php/get_dept_hospital/"+dept_id+"/";
		...
		@Override
		 protected void onPostExecute(Void result) {
		        ...
		        ListAdapter adapter = new SimpleAdapter(
		                CatHosListActivity.this, hospitalList,
		                R.layout.hospital_layout, new String[] { TAG_ID,TAG_NAME, 
		                         TAG_ADDRESS }, new int[] { R.id.h_id,R.id.name,
		                         R.id.address });
