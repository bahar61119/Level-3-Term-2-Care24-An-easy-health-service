...
//import com.care24.care24.ReportListActivity.GetReports;
import com.care24.json.ServiceHandler;

public class PrescriptionListActivity extends ListActivity{
 ...
 ////////////////////////////////////////////////////////////////////
    ...
    private class GetPrescriptions extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PrescriptionListActivity.this);
		...
		@Override
		 protected void onPostExecute(Void result) {
		        ...
		        ListAdapter adapter = new SimpleAdapter(
		                PrescriptionListActivity.this, prescriptionList,
