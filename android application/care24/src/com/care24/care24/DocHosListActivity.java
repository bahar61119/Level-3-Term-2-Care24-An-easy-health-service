...
public class DocHosListActivity extends ListActivity{
    ...
    private static final String TAG_H_ID = "h_id";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dept_id = this.getIntent().getStringExtra("h_id");
		h_id= this.getIntent().getStringExtra("dept_id");
 ...
 ////////////////////////////////////////////////////////////////////
    ...
    private class GetDoctors extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(DocHosListActivity.this);
		...
		protected Void doInBackground(Void... params) {
            ...
            url= ""+CommonUtilities.SERVER_URL+"/api.php/get_doc_hospital/"+h_id+"/"+dept_id+"/";
		...
		@Override
		 protected void onPostExecute(Void result) {
		        ...
		        ListAdapter adapter = new SimpleAdapter(
		                DocHosListActivity.this, doctorList,
		                R.layout.daoctor_layout, new String[] { TAG_ID,TAG_NAME,
		                          TAG_SPECIALIST}, new int[] { 
		                		R.id.d_id,R.id.name,
		                         R.id.specialist });
