...
public class AllHosDocListActivity extends ListActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        h_id = this.getIntent().getStringExtra("id");
 ...
 ////////////////////////////////////////////////////////////////////
    ...
    private class GetDoctors extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(AllHosDocListActivity.this);
		...
		protected Void doInBackground(Void... params) {
            ...
            url= ""+CommonUtilities.SERVER_URL+"/api.php/get_all_doc_hospital/"+h_id+"/";
		...
		@Override
		 protected void onPostExecute(Void result) {
		        ...
		        ListAdapter adapter = new SimpleAdapter(
		                AllHosDocListActivity.this, doctorList,
